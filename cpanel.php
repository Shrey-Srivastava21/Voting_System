    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg"><strong>UP MATDAAN E-Voting 2022</strong></a>
        </div>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Yogi Adityanath</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                $sql ="SELECT * FROM tbl_users WHERE voted_for='Congress'";
                $result= mysqli_query($conn, $sql);
